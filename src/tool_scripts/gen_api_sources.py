...
class Generator:
    ...
    def generate_api(self, api: ApiDef, out_dir: Path):
        ...
        if self._src_sfx:
            src_ctx = GenCtx()
            src_out_path = out_dir / f"{api.name}{self._src_sfx}"
...
class CGenerator(Generator):
    ...
    def _generate_api(self, api: ApiDef, src_ctx: GenCtx, hdr_ctx: Optional[GenCtx]):
        hdr_ctx.add_lines("#pragma once // C")
        src_ctx.add_lines("#include <stdlib.h> // C")
...
class CppGenerator(Generator):
    ...
    def _generate_api(self, api: ApiDef, src_ctx: GenCtx, hdr_ctx: Optional[GenCtx]):
        hdr_ctx.add_lines("#pragma once // CPP")
        src_ctx.add_lines("#include <stdlib.h> // CPP")
...
class WasmBindingGenerator(CppGenerator):
    ...
    def _generate_api(self, api: ApiDef, src_ctx: GenCtx, hdr_ctx: Optional[GenCtx]):
        src_ctx.add_lines("#include <stdlib.h> // WASM BINDING")
...
class JniBindingGenerator(CppGenerator):
    ...
    def _generate_api(self, api: ApiDef, src_ctx: GenCtx, hdr_ctx: Optional[GenCtx]):
        src_ctx.add_lines("#include \"jni.h\"")
...
class SwiftBindingGenerator(CGenerator):
    _hdr_sfx = None
    ...
    def _generate_api(self, api: ApiDef, src_ctx: Optional[GenCtx], hdr_ctx: Optional[GenCtx]):
        src_ctx.add_lines("#include <stdlib.h> // SWIFT BINDING")
