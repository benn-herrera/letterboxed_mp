...
set(THIRD_PARTY_VERSION_DIR "${THIRD_PARTY_INSTALL_DIR}/version")
...
make_directory("${THIRD_PARTY_VERSION_DIR}")

include_directories("${THIRD_PARTY_DIR}/install/include")

function(bng_add_3p_header_lib NAME REPO VERSION INTERFACE_DIR)
  set(LIB_SRC_DIR "${THIRD_PARTY_DIR}/${NAME}")
  set(LIB_INCLUDE_DIR "${THIRD_PARTY_INCLUDE_DIR}/${NAME}")
  set(VERSION_FILE "${THIRD_PARTY_VERSION_DIR}/${NAME}.txt")
  file(READ "${VERSION_FILE}" CUR_VERSION)

  if (NOT STREQUAL VERSION CUR_VERSION)
    file(REMOVE_RECURSE "${LIB_SRC_DIR}")
    file(REMOVE "${LIB_INCLUDE_DIR}")
    ...
    create_link("${INTERFACE_DIR}" "${LIB_INCLUDE_DIR}" SYMBOLIC)
    file(WRITE "${VERSION_FILE}" "${VERSION}")
  endif()
endfunction()

function(bng_add_3p_lib NAME REPO VERSION)
  set(LIB_SRC_DIR "${THIRD_PARTY_DIR}/${NAME}")
  ...
  if (NOT STREQUAL VERSION CUR_VERSION)
    ...
    Cmake("${LIB_BUILD_DIR}" --build .  --config=RelWithDebInfo --target=install)
    file(WRITE "${VERSION_FILE}" "${VERSION}")
  endif()
endfunction()