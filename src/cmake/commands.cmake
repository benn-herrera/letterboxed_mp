...
function(GenApiSources WORKING_DIR)
    Python("${WORKING_DIR}" "${GenApiSources_SCRIPT}" ${ARGN})
endfunction()
if(NOT EXISTS "${GenApiSources_SCRIPT}")
  message(FATAL_ERROR "${GenApiSources_SCRIPT} does not exist.")
endif()
